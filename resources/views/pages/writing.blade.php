        ...
        <div class="page-content">
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <!-- Classic Heading -->
              <h4 class="classic-title"><span>การเขียนและเนื้อหา</span></h4>
              ...
              <div class="row">
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <a href="services-1.html">
                    <div class="service-icon">
                      <i class="fa fa-newspaper-o icon-medium"></i>
                    </div>
                    <div class="service-content">
                      <h4>เขียนคอนเท็นต์</h4>
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <div class="service-icon">
                    <i class="fa fa-book icon-medium"></i>
                  </div>
                  <div class="service-content">
                    <h4>เขียนนิยาย / เรื่องสั้น</h4>
                    <p>It is a long <strong class="accent-color">established</strong> fact that a reader will be distracted by the readable content of a page.</p>
                  </div>
                </div>
                <!-- End Service Icon 2 -->
