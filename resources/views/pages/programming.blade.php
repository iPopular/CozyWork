        ...
        <div class="page-content">
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <!-- Classic Heading -->
              <h4 class="classic-title"><span>เว็บไซต์และโปรแกรมมิ่ง</span></h4>
              ...
              <div class="row">
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <a href="services-1.html">
                    <div class="service-icon">
                      <i class="fa fa-window-maximize icon-medium"></i>
                    </div>
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <div class="service-icon">
                    <i class="fa fa-wordpress icon-medium"></i>
                  </div>
                  <div class="service-content">
                    <h4>Wordpress</h4>
                    <p>It is a long <strong class="accent-color">established</strong> fact that a reader will be distracted by the readable content of a page.</p>
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <div class="service-icon">
                    <i class="fa fa-mobile icon-medium"></i>
                  </div>
                  <div class="service-content">
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <div class="service-icon">
                    <i class="fa fa-html5 icon-small"></i><i class="fa fa-css3 icon-small"></i>
                  </div>
                  <div class="service-content">
                    <h4>HTML / CSS</h4>
                    <p>It is a long <strong class="accent-color">established</strong> fact that a reader will be distracted by the readable content of a page.</p>
