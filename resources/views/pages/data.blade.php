        ...
        <div class="page-content">
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <!-- Classic Heading -->
              <h4 class="classic-title"><span>การคีย์ข้อมูลและธุรการ</span></h4>
              ...
              <div class="row">
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <a href="services-1.html">
                    <div class="service-icon">
                      <i class="fa fa-keyboard-o icon-medium"></i>
                    </div>
                    <div class="service-content">
                      <h4>คีย์ข้อมูลทั่วไป</h4>
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <div class="service-icon">
                    <i class="fa fa-file-excel-o icon-medium"></i>
                  </div>
                  <div class="service-content">
                    <h4>Excel</h4>
                    <p>It is a long <strong class="accent-color">established</strong> fact that a reader will be distracted by the readable content of a page.</p>
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <div class="service-icon">
                    <i class="fa fa-spinner icon-medium"></i>
                  </div>
                  <div class="service-content">
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <div class="service-icon">
                    <i class="fa fa-user-md icon-medium"></i>
                  </div>
                  <div class="service-content">
                    <h4>ผู้ช่วยเสมือน</h4>
                    <p>It is a long <strong class="accent-color">established</strong> fact that a reader will be distracted by the readable content of a page.</p>
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <div class="service-icon">
                    <i class="fa fa-search icon-medium"></i>
                  </div>
                  <div class="service-content">
                    <h4>การค้นหาเว็บไซต์</h4>
                    <p>It is a long <strong class="accent-color">established</strong> fact that a reader will be distracted by the readable content of a page.</p>
                  </div>
                </div>
                <!-- End Service Icon 5 -->   
