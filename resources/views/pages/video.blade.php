        ...
        <div class="page-content">
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <!-- Classic Heading -->
              <h4 class="classic-title"><span>ถ่ายภาพ วิด๊โอ และเสียง</span></h4>
              ...
              <div class="row">
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <a href="services-1.html">
                    <div class="service-icon">
                      <i class="fa fa-camera-retro icon-medium"></i>
                    </div>
                    <div class="service-content">
                      <h4>ถ่ายภาพ / ถ่ายวิดีโอ</h4>
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <div class="service-icon">
                    <i class="fa fa-file-video-o icon-medium"></i>
                  </div>
                  <div class="service-content">
                    <h4>วิดีโอพรีเซนเทชั่น</h4>
                    <p>It is a long <strong class="accent-color">established</strong> fact that a reader will be distracted by the readable content of a page.</p>
                  </div>
                </div>
                <!-- End Service Icon 2 -->
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <div class="service-icon">
                    <i class="fa fa-scissors icon-medium"></i>
                  </div>
                  <div class="service-content">
                    <h4>ตัดต่อวิดีโอ</h4>
                    <p>It is a long <strong class="accent-color">established</strong> fact that a reader will be distracted by the readable content of a page.</p>
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <div class="service-icon">
                    <i class="fa fa-file-audio-o icon-medium"></i>
                  </div>
                  <div class="service-content">
                    <h4>เอฟเฟคเสียง</h4>
                    <p>It is a long <strong class="accent-color">established</strong> fact that a reader will be distracted by the readable content of a page.</p>
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <div class="service-icon">
                    <i class="fa fa-blind icon-medium"></i>
                  </div>
                  <div class="service-content">
              ...
              <div class="our-clients">
                ...
                <div class="clients-carousel custom-carousel touch-carousel" data-appeared-items="4">
                  ...
                  <div class="client-item item">
                    <a href="#"><img src="{{ URL::asset('images/c1.png')}}" alt="" /></a>
                  </div>

                  <!-- Client 2 -->
                  <div class="client-item item">
                    <a href="#"><img src="{{ URL::asset('images/c2.png')}}" alt="" /></a>
                  </div>

                  <!-- Client 3 -->
                  <div class="client-item item">
                    <a href="#"><img src="{{ URL::asset('images/c3.png')}}" alt="" /></a>
                  </div>

                  <!-- Client 4 -->
                  <div class="client-item item">
                    <a href="#"><img src="{{ URL::asset('images/c4.png')}}" alt="" /></a>
                  </div>

                  <!-- Client 5 -->
                  <div class="client-item item">
                    <a href="#"><img src="{{ URL::asset('images/c5.png')}}" alt="" /></a>
                  </div>

                  <!-- Client 6 -->
                  <div class="client-item item">
                    <a href="#"><img src="{{ URL::asset('images/c6.png')}}" alt="" /></a>
                  </div>

                  <!-- Client 7 -->
                  <div class="client-item item">
                    <a href="#"><img src="{{ URL::asset('images/c7.png')}}" alt="" /></a>
                  </div>

                  <!-- Client 8 -->
                  <div class="client-item item">
                    <a href="#"><img src="{{ URL::asset('images/c8.png')}}" alt="" /></a>
                  </div>
