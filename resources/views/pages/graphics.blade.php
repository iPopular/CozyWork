        ...
        <div class="page-content">
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <!-- Classic Heading -->
              <h4 class="classic-title"><span>วาดและกราฟิกดีไซน์</span></h4>
              ...
              <div class="row">
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <div class="service-icon">
                    <i class="fa fa-pencil-square-o icon-medium"></i>
                  </div>
                  <div class="service-content">
                    <h4>วาดการ์ตูน</h4>
                    <p>It is a long <strong class="accent-color">established</strong> fact that a reader will be distracted by the readable content of a page.</p>
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <div class="service-icon">
                    <i class="fa fa-linode icon-medium"></i>
                  </div>
                  <div class="service-content">
                    <h4>เขียนแบบ</h4>
                    <p>It is a long <strong class="accent-color">established</strong> fact that a reader will be distracted by the readable content of a page.</p>
                ...
                <div class="col-md-6 service-box service-icon-left-more">
                  <div class="service-icon">
                    <i class="fa fa-edge icon-medium"></i>
                  </div>
                  <div class="service-content">
                    <h4>ออกแบบเว็บไซต์</h4>
                    <p>It is a long <strong class="accent-color">established</strong> fact that a reader will be distracted by the readable content of a page.</p>
                  </div>
                </div>
                <!-- End Service Icon 6 -->
